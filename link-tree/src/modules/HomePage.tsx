  ...
  return (
    ...
    >
      <div className={"max-w-2xl mx-auto my-8 relative"}>
        <div
          className={
            "absolute md:left-full right-0 lg;right-auto left-full bottom-full"
          }
        >
          <Button
            variant={"secondary"}
                ...
                >
                  <Button
                    ...
                    onClick={() =>
                      setModal({
                        open: true,
                        link: { title: link.title, url: link.href },
                      })
                    }
                  >
                    <DotsHorizontalIcon />
      ...
      >
        ...
        <DialogContent
          className={
            "sm:max-w-sm md:max-w-lg rounded-t-2xl md:rounded-2xl top-full -translate-y-full sm:top-1/2 sm:-translate-y-1/2"
          }
        >
          <DialogHeader>
          ...
          <div className={"grid gap-4"}>
            ...
            {modal.link.url === curHref ? (
              <div
                className={
                  "relative aspect-video w-full rounded-3xl overflow-hidden"
                }
              >
                <Image
                  src={"/opengraph-image"}
              ...
              <motion.a
                ...
                target={"_blank"}
                className={
                  "flex flex-col gap-1 items-center py-6 px-5 w-full sm:max-w-80 mx-auto bg-stone-100 dark:bg-accent rounded-3xl"
                }
              ...
              >
                ...
                <p
                  className={
                    "text-[13px] text-center whitespace-nowrap w-36 text-ellipsis overflow-hidden"
                  }
                >
                  {modal.link.url}
                </p>
            ...
            <div className="flex items-start justify-center gap-4 my-4">
              ...
              >
                <div
                  className={
                    " bg-neutral-200 dark:bg-accent flex items-center justify-center w-12 h-12 rounded-full overflow-hidden mx-2"
                  }
                >
                  {copiedLink ? (
                    <CheckIcon
                    ...
                    <Link2Icon className={"w-5 h-5"}></Link2Icon>
                  )}
                </div>
                {copiedLink ? (
              ...
              >
                <div
                  className={
                    "flex items-center justify-center w-12 h-12 rounded-full overflow-hidden mx-2"
                  }
                >
                  <XIcon className={"w-full h-full"}></XIcon>
                </div>
